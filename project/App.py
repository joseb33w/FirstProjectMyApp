...
def dynamic_import(module_path, module_name):
    module_path = os.path.abspath(module_path)  # Resolve the absolute path
...
for_you_path = os.path.join(base_dir, "modules", "2_For_you.py")
retirement_calculator_path = os.path.join(base_dir, "modules", "3_Retirement_Calculator.py")
