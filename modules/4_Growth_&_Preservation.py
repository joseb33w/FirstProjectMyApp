...
def calculate_retirement_insights():
    ...
    # Including monthly contributions in the future value calculation
    for month in range(months_until_retirement):
        future_value *= (1 + (st.session_state.annual_return / 100) / 12)
        future_value += st.session_state.monthly_contribution
