...
growth_preservation_path = os.path.join(modules_dir, "5_Growth_&_Preservation.py")
...
def main_app():
    ...
    page = st.sidebar.radio("Go to", ["For You", "Retirement", "Current Retirement", "Growth & Preservation"])

    # Navigate to the selected page dynamically
    if page == "For You":
        for_you_module.main()
    elif page == "Retirement":
        retirement_module.main()
