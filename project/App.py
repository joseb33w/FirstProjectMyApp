...
# Debug the current working directory and list all files
...
try:
    for_you_module = dynamic_import("modules/2_For_you.py", "for_you")  # Updated path to match "modules/" folder
    retirement_calculator_module = dynamic_import("modules/3_Retirement_Calculator.py", "retirement_calculator")
