...
current_retirement_path = os.path.join(modules_dir, "4_Current_Retirement.py")

# Dynamically import the "For You", "Retirement", and "Current Retirement" pages
try:
...
def main_app():
    ...
    page = st.sidebar.radio("Go to", ["For You", "Retirement", "Current Retirement"])
    ...
    if page == "For You":
        ...
        current_retirement_module.main()  # Call the "Current Retirement" page's main function
