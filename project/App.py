...
# Debugging: Ensure paths are being resolved correctly
st.write("Base directory:", base_dir)
st.write("Modules directory:", modules_dir)

# Resolve the actual paths of the modules
for_you_path = os.path.join(modules_dir, "2_For_you.py")
retirement_calculator_path = os.path.join(modules_dir, "3_Retirement_Calculator.py")

# Debugging: Verify module paths
st.write("For You Path:", for_you_path)
st.write("Retirement Calculator Path:", retirement_calculator_path)

# Dynamically import the "For You" and "Retirement Calculator" pages
try:
    for_you_module = dynamic_import(for_you_path, "for_you")
    retirement_calculator_module = dynamic_import(retirement_calculator_path, "retirement_calculator")
