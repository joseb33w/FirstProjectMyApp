...
# Correctly resolve paths dynamically based on App.py location
base_dir = os.path.dirname(os.path.abspath(__file__))  # Directory of App.py
modules_dir = os.path.join(base_dir, "modules")  # Adjust to "modules" directly without extra "project/"
