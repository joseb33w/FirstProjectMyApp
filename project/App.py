...
# Resolve paths dynamically based on the correct directory
base_dir = os.path.abspath(os.getcwd())  # Use the working directory as the base
modules_dir = os.path.join(base_dir, "project", "modules")  # Ensure this is accurate
