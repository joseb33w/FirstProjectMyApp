...
def display_savings_chart(data):
    ...
    # Display investment news summary
    st.markdown("<h3 style='font-size:28px;'>Investment News</h3>", unsafe_allow_html=True)
    investment_news = {
        "Stocks": "The stock market saw a 5% growth due to strong corporate earnings and tech sector performance.",
        "Bonds": "Bond returns remained stable at 2% amid low interest rates and a steady economy.",
        "Real Estate": "The real estate market surged with an 8% return, driven by increased demand for properties in suburban areas."
    }
    for investment, news in investment_news.items():
        st.markdown(f"**{investment}:** {news}")
